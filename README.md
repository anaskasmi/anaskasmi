...
<a href="https://twitter.com/anaskasmi">
...
```yaml
name: Anas KASMI
located_in: Casblanca, Morocco (Happy to relocate)
current_job: Full Stack Developer
education:
  [
    "Master Degree in computer sience",
    "Certified in SCRUM",
    "Microsoft certified in MTA Databases",
    "Node JS Certified by Udemy" 
  ]
current_company: "Acronis",
fields_of_interests:
  [
